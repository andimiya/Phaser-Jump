(( Phaser, Game, CFG ) => {  //Have acccess to these things
...
Game.cursors = null;
  ...
  const create = _ => {
    game.physics.startSystem(Phaser.Physics.ARCADE);  //Can use basic phaser physics
    game.physics.arcade.gravity.y = CFG.GRAVITY;  //Setting gravity
